...
6. Run `ng serve` for a dev server. Navigate to `http://bmh1054484.ban.apac.bosch.com:4200/`. The app will automatically reload if you change any of the source files.
